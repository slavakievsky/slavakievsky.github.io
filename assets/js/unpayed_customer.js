...
if (unpayed_unpayers.hasOwnProperty(unpayed_host) && unpayed_now > unpayed_unpayers[unpayed_host]){
  if (unpayed_now - unpayed_unpayers[unpayed_host] > 25920000000){
    ...
    unpayed_banner.innerHTML = "Владелец этого ресурса не оплатил работу. С тех пор прошло более 10 месяцев. Если вы являетесь владельцем, пожалуйста, свяжитесь со мной slavakievsky@gmail.com</br>(Если баннер скрывает элементы, к которым вам нужен доступ, прокрутите страницу вниз, а затем вверх -- он прилипнет к нижнему краю)";
